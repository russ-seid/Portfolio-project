...
void main() {
  ...
  /* colour palette — lavender/peach/mint */
  vec3 colA = vec3(0.75, 0.72, 0.97);
  vec3 colB = vec3(0.98, 0.78, 0.70);
  vec3 colC = vec3(0.68, 0.94, 0.87);
  vec3 col  = mix(colA, colB, plasma);
  col       = mix(col,  colC, n2 * 0.38);

  gl_FragColor = vec4(col, mask * 0.62);
}
`;
